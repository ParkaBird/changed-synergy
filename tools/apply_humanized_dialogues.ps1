...
Update-Field "dialogue.changed_synergy.dark.success_assimilate.0" "站稳了！欢迎加入，先认识一下周围的兄弟们。"
Update-Field "dialogue.changed_synergy.dark.success_assimilate.1" "搞定！从现在起你就是咱们这一边的了。"
Update-Field "dialogue.changed_synergy.dark.success_assimilate.2" "不错嘛，新来的小子看着挺有精神的。"
...
Update-Field "dialogue.changed_synergy.organic.success_assimilate.0" "完成了。慢慢适应呼吸和身体的新节奏吧。"
...
Update-Field "dialogue.changed_synergy.aquatic.success_assimilate.0" "好啦！先在浅水里泡泡，很快就能适应新尾巴啦。"
Update-Field "dialogue.changed_synergy.aquatic.success_assimilate.1" "欢迎加入水域！别急，跟着水流游两圈就习惯啦。"
...
Update-Field "dialogue.changed_synergy.light.success_assimilate.0" "抓到啦！看看你这新身手，看起来挺带感的嘛！"
